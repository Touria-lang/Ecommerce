              ...
              <table class="table">
                ...
                @foreach (cart::content() as $cart)  
                    <tr>
                        ...
                        <div class="p-2">
                            <img src="{{$cart->model->image}}" alt="" width="70" class="img-fluid rounded shadow-sm">
                            <div class="ml-3 d-inline-block align-middle">
                            <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block align-middle">{{$cart->model->title}}</a></h5><span class="text-muted font-weight-normal font-italic d-block">Category: Watches</span>
                            </div>
                        </div>
                        </th>
                        <td class="border-0 align-middle"><strong>{{getPrice($cart->subtotal())}}</strong></td>
                        <td class="border-0 align-middle">
                          <strong>
                            <select name="qty" id="qty" class="custom-select" data-id="{{$cart->rowId}}">
                              @for ($i = 1; $i < 7; $i++)
        ...
        <div class="row py-5 p-4 bg-white rounded shadow-sm">
          ...
          <div class="col-lg-6">
            ...
            <div class="p-4">
              ...
              </ul><a href="{{route("stripes.index")}}" class="btn btn-dark rounded-pill py-2 btn-block">Passer a la caisse</a>
            </div>
          </div>
        </div>
